        ...
        >
          {status === 'confirming' && (
            <>
              ...
              <p className="text-foreground/60 mb-8">
                Are you sure you want to stop receiving updates at <span className="text-foreground font-medium">{decodedEmail}</span>?
              </p>
          ...
          {status === 'processing' && (
            <div className="py-12">
               ...
               <p className="text-foreground/60">Updating your preferences...</p>
            </div>
          )}

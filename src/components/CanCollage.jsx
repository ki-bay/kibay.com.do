...
const canImageMeta = [
  { id: 1, src: "/unsplash/photo-1703173354700-0b2028e117aa.webp", altKey: "altMango", rotation: -3, yOffset: 0 },
  { id: 2, src: "/unsplash/photo-1546568133-a7dc44ae2955.webp", altKey: "altPassion", rotation: 4, yOffset: 40 },
  { id: 3, src: "/unsplash/photo-1703581672849-951cbd41e3ac.webp", altKey: "altTropical", rotation: -2, yOffset: 10 },
  { id: 4, src: "/unsplash/photo-1703173354700-0b2028e117aa.webp", altKey: "altMangoReserve", rotation: 5, yOffset: 50 },
  { id: 5, src: "/unsplash/photo-1703581672849-951cbd41e3ac.webp", altKey: "altSunset", rotation: -4, yOffset: 20 },
  { id: 6, src: "/unsplash/photo-1546568133-a7dc44ae2955.webp", altKey: "altClassic", rotation: 2, yOffset: 60 }
];

const CanCollage = () => {
  const { t } = useTranslation('canCollage');
  return (

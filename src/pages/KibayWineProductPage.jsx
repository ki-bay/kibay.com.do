...
const KibayWineProductPage = () => {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative min-h-[85vh] flex items-center bg-slate-900 pt-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.h1 variants={fadeIn} className="text-5xl sm:text-6xl md:text-7xl font-light text-white leading-tight">
                KiBay <br/><span className="text-[#D4A574]">Wine</span>
              </motion.h1>
              <motion.div variants={fadeIn} className="space-y-4">
                <h2 className="text-2xl text-white/90 font-light">Tropical Wine Crafted at Ocoa Bay</h2>
              ...
              <motion.div variants={fadeIn} className="pt-4">
                <Link to="/shop">
                  <Button className="bg-[#D4A574] hover:bg-[#b0865a] text-white px-8 py-6 text-lg rounded-full font-normal shadow-[0_0_20px_rgba(212,165,116,0.3)] transition-all hover:scale-105">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-900">
        <div className="max-w-4xl mx-auto text-center mb-16">
           ...
           >
              <h2 className="text-3xl md:text-5xl font-light text-white mb-6">Rooted in Place</h2>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
           ...
           <div className="space-y-6">
              <h3 className="text-2xl font-normal text-white">A Unique Terroir</h3>
         ...
         <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-16">
               <motion.div 
                 ...
                 className="space-y-8"
               >
                  <h2 className="text-3xl md:text-4xl font-light text-white">A Taste of the Caribbean</h2>
                  <div className="space-y-6">
                     <div className="flex gap-4">
                        <div className="p-3 bg-slate-900 rounded-lg h-fit border border-white/10">
                           <Sun className="w-6 h-6 text-[#D4A574]" />
                        </div>
                        <div>
                           <h3 className="text-xl font-normal text-white mb-2">Aromatic Expression</h3>
                     ...
                     <div className="flex gap-4">
                        ...
                        <div>
                           <h3 className="text-xl font-normal text-white mb-2">Body & Structure</h3>
                           <p className="text-white/70 font-light">
               ...
               <motion.div 
                 ...
                 viewport={{ once: true }}
                 transition={{ duration: 0.6 }}
                 className="bg-slate-900 p-8 rounded-2xl border border-white/5 flex flex-col justify-center"
               >
                  <h3 className="text-2xl font-normal text-white mb-6 text-center">The Essence of KiBay</h3>
                  <p className="text-xl text-white/80 font-light italic text-center mb-8">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-900">
        <div className="max-w-4xl mx-auto text-center mb-12">
           <h2 className="text-3xl md:text-4xl font-light text-white mb-6">Moments Worth Savoring</h2>
           <p className="text-white/60 font-light">Designed to complement the Caribbean climate and cuisine.</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
           {[
              ...
              <motion.div 
                 ...
                 className="bg-slate-800/20 p-8 rounded-xl border border-white/5 text-center hover:bg-slate-800/40 transition-colors"
              >
                 <item.icon className="w-10 h-10 text-[#D4A574] mx-auto mb-4" />
                 <h3 className="text-xl font-normal text-white mb-3">{item.title}</h3>
                 <p className="text-white/70 font-light">{item.text}</p>
              </motion.div>
           ))}
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-slate-900 to-slate-950">
         <div className="max-w-5xl mx-auto bg-slate-800/30 rounded-3xl p-8 md:p-12 border border-white/5">
            <div className="text-center">
               <Heart className="w-12 h-12 text-[#D4A574] mx-auto mb-6" />
               <h2 className="text-3xl font-light text-white mb-6">Two Expressions, One Origin</h2>
               <p className="text-lg text-white/80 font-light leading-relaxed mb-8 max-w-3xl mx-auto">
               ...
               <div className="flex flex-col sm:flex-row justify-center gap-4">
                  <Link to="/kibay-sparkling">
                     <Button variant="outline" className="border-[#D4A574] text-[#D4A574] hover:bg-[#D4A574] hover:text-white font-normal">
                        Discover Sparkling
                     </Button>
                  </Link>
                  <Link to="/shop">
                     <Button className="bg-[#D4A574] text-white hover:bg-[#b0865a] font-normal">
                        Shop All Wines
                     </Button>
                  </Link>
               </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-slate-950 text-center">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-light text-white mb-6">Heritage & Innovation</h2>

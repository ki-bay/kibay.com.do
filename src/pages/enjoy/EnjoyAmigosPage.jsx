...
const HERO_IMAGE = 'https://res.cloudinary.com/dwewurxla/image/upload/v1778724134/Babula_Shots_Rd_-60_dbwlky.webp';
const GALLERY = [
  'https://res.cloudinary.com/dwewurxla/image/upload/v1778724131/Babula_Shots_Rd_-52_kgalqt.webp',
  'https://res.cloudinary.com/dwewurxla/image/upload/v1778724131/Babula_Shots_Rd_-46_iyjidf.webp',
  'https://res.cloudinary.com/dwewurxla/image/upload/v1778724132/Babula_Shots_Rd_-28_qivkr5.webp',
  'https://res.cloudinary.com/dwewurxla/image/upload/v1778724132/Babula_Shots_Rd_-38_d7xhhp.webp',
  'https://res.cloudinary.com/dwewurxla/image/upload/v1778724133/Babula_Shots_Rd_-33_gclwnz.webp',
];
...
const EnjoyAmigosPage = () => {
  const { t, i18n } = useTranslation('enjoyAmigos');
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8 bg-background">
          <m.div {...fadeIn} className="max-w-3xl mx-auto">
            <div className="flex items-center gap-2 text-[#D4A574] text-sm uppercase tracking-[0.25em] mb-6">
              ...
              <span>Casa Club · Bahía de Ocoa</span>
            </div>
...
export default EnjoyAmigosPage;

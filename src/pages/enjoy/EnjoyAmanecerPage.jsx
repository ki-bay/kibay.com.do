...
const HERO_IMAGE = 'https://res.cloudinary.com/dwewurxla/image/upload/v1778724993/Babula_Shots_Rd_-75_doytfj.webp';
const GALLERY = [
  'https://res.cloudinary.com/dwewurxla/image/upload/v1778724990/Babula_Shots_Rd_-70_gcqrud.webp',
  'https://res.cloudinary.com/dwewurxla/image/upload/v1778724989/Babula_Shots_Rd_-67_r3w7ia.webp',
];
...
const EnjoyAmanecerPage = () => {
  const { t, i18n } = useTranslation('enjoyAmanecer');
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8 bg-background">
          <m.div {...fadeIn} className="max-w-3xl mx-auto">
            <div className="flex items-center gap-2 text-[#D4A574] text-sm uppercase tracking-[0.25em] mb-6">
              ...
              <span>Bahía de Ocoa · República Dominicana</span>
            </div>
...
export default EnjoyAmanecerPage;

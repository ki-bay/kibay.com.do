...
const COPY = {
  es: {
    ...
    body: 'El verdadero argumento para una carta seria es poder describir unos vinos locales en un terroir dominicano, en una mesa donde los huéspedes esperan vinos europeos. Nuestras etiquetas (Kibay Vino, Kibay Espumante) abren un menú de maridaje propio.',
  ...
  en: {
    ...
    body: 'The real case for a serious wine list is being able to describe local wines from a Dominican terroir, at a table where guests expect European wine. Our labels (Kibay Vino, Kibay Espumante) open up a pairing menu of their own.',

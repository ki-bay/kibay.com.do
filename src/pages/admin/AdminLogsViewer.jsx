              ...
              <table className="w-full text-sm text-left font-mono">
                <thead className="text-xs text-stone-500 uppercase bg-stone-100 border-b">
                  <tr>
                    ...
                    <th className="px-6 py-3">{t('table.function')}</th>
                ...
                <tbody className="divide-y divide-stone-100">
                  {loading ? (
                    ...
                    <tr><td colSpan="4" className="text-center py-12 text-stone-500">{t('table.empty')}</td></tr>
                    ...
                    <tr key={log.id} className="hover:bg-stone-50 transition-colors">
                      ...
                      <td className="px-6 py-3">
                        {log.status === 'success' ?
                          <span className="text-green-600 font-semibold">{t('status.success')}</span> :
                          <span className="text-red-600 font-semibold" title={log.error_message}>{t('status.error')}</span>
                        }
                      </td>
                    </tr>
                  ))}

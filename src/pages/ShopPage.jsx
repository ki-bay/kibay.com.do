  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-900 pt-20">
        ...
        {/* Newsletter Section */}
        <section className="bg-slate-800 py-20 px-4 border-t border-white/5">
           <div className="max-w-4xl mx-auto text-white"> {/* Added text-white here */}
              <NewsletterSignup 
        ...
        <section className="bg-slate-900 py-24 px-4 border-t border-white/5 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-6">Crafted by Nature, Perfected by Passion</h2>
            ...
            <Link to="/about">
              <span className="inline-block border-b border-orange-500 text-white font-medium hover:text-orange-500 hover:border-orange-400 transition-colors cursor-pointer pb-1">
                Read our full story
              </span>
            </Link>
          </div>

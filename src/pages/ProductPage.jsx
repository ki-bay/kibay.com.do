          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            once: true
              ...
              <Card className="p-8 text-center hover:shadow-2xl hover:shadow-orange-500/20 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold mb-3 text-foreground">Aroma</h3>
            ...
            once: true
              ...
              <Card className="p-8 text-center hover:shadow-2xl hover:shadow-orange-500/20 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold mb-3 text-foreground">Palate</h3>
                <p className="text-foreground/70">
            ...
            once: true
              ...
              <Card className="p-8 text-center hover:shadow-2xl hover:shadow-orange-500/20 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold mb-3 text-foreground">Finish</h3>
                <p className="text-foreground/70">
          ...
          once: true
            ...
            <Card className="p-8 mb-8">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2 text-foreground">Perfect Temperature</h3>
                  <p className="text-foreground/70">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2 text-foreground">Pairing Ideas</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            once: true
              ...
              <Card className="p-8 h-full hover:shadow-2xl hover:shadow-orange-500/20 transition-all duration-300">
                ...
                <h3 className="text-2xl font-bold mb-4 text-foreground">Dominican Heritage</h3>
                <p className="text-foreground/70 mb-4">
          ...
          once: true
            ...
            <Card className="p-8">
              <div className="space-y-6">
                <div>
                  <span className="inline-block bg-gradient-to-r from-orange-500 to-orange-600 text-foreground px-4 py-2 rounded-full text-sm font-bold mb-3">
                    Step 1
                  </span>
                ...
                <div>
                  ...
                  <h3 className="text-xl font-bold mb-2 text-foreground">Natural Fermentation</h3>
                  <p className="text-foreground/70">
                ...
                <div>
                  ...
                  <h3 className="text-xl font-bold mb-2 text-foreground">Carbonation & Aging</h3>
                  <p className="text-foreground/70">
                ...
                <div>
                  ...
                  <h3 className="text-xl font-bold mb-2 text-foreground">Premium Canning</h3>
                  <p className="text-foreground/70">
